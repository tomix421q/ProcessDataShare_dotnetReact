...
const url = `http://${config.apiBaseUrl}:5147/api/eqcmachines/eqc2`
        ...
        <div className={`${!comError && !loadingData ? 'flex' : 'hidden'} w-full`}>
          <div className='w-full'>
            ...
            <div className='text-center border-b border-collor1 border shadow-2xl shadow-black rounded-lg bg-gray-800'>
              <h1 className='text-4xl md:text-8xl text-collor2 font-thin font-extraFont rounded-lg pt-2'>EQC MF 2</h1>
