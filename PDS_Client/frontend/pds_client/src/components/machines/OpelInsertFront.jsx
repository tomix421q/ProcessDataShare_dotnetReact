...
const url = `http://${config.apiBaseUrl}:5147/api/opelmachines/insertfront`

const OpelInsertFront = () => {
        ...
        <div className={`${!comError && !loadingData ? 'flex' : 'hidden'} w-full`}>
          <div className='w-full'>
            ...
            <div className='text-center border-b border-collor1 border shadow-2xl shadow-black rounded-lg bg-gray-800'>
              <h1 className='text-4xl md:text-8xl text-collor2 font-thin font-extraFont rounded-lg py-2'>Opel Insert Front</h1>
            ...
            <div className='flex flex-col lg:flex-row my-8 gap-y-4 justify-center gap-x-24'>
              ...
              <div className='leading-relaxed border-collor1 border p-6 shadow-2xl shadow-black rounded-lg hover:scale-105 ease-in duration-200 min-w-[28%] bg-gray-800'>
                ...
                <p>
                  Part recipe : <span className='font-bold text-secondary text-xl'>{data.partRecipe}</span>
                </p>
                <p>
              ...
              <div className='leading-relaxed border-collor1 border p-6 shadow-2xl shadow-black rounded-lg hover:scale-105 ease-in duration-200 min-w-[28%] bg-gray-800'>
                ...
                <p>
                  Pyrometer on :
                  <span className='font-bold text-secondary text-xl'> {data.pyroIndicatorOnOff ? 'yes' : 'no'}</span>
                </p>
                <p>
                  Work A side :<span className='font-bold text-secondary text-xl'> {data.workside_A ? 'yes' : 'no'}</span>
                </p>
                <p>
                  Work B side :<span className='font-bold text-secondary text-xl'> {data.workside_B ? 'yes' : 'no'}</span>
                </p>
                <p>
...
export default OpelInsertFront
